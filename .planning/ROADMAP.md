...
- [ ] **Phase 1: Niche Config + Multi-Channel Foundation** - Define per-channel config, isolate backlogs and credentials, wire multi-channel CLI targeting
...
|-------|----------------|--------|-----------|
| 1. Niche Config + Multi-Channel Foundation | 1/3 | In Progress|  |
